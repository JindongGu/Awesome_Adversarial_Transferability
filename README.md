...
* Abbreviation tag, e.g., ![](https://img.shields.io/badge/CLIP-CD6155?style=flat-square) <svg width="347" height="233" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" overflow="hidden"><defs><clipPath id="a"><path d="M1179 269h347v233h-347z"/></clipPath></defs><g clip-path="url(#a)" transform="translate(-1179 -269)"><path fill="#4472C4" d="M1179 269h347v201h-347z"/><text fill="#FFF" font-family="Times New Roman,Times New Roman_MSFontService,sans-serif" font-weight="400" font-size="110" transform="translate(1261.05 410)">data</text></g></svg>
